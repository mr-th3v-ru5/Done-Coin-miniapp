...
(function () {
  ...
  const BET_CONTRACT_ADDRESS = "0x6C12Bcb420f491140cb135A5Cc954a5B59cB1033";
  ...
  async function connectWallet() {
    ...
    try {
      ...
      // optional sign-in message for normal browsers (non-mini)
      if (!isMini && state.signer) {
        try {
          const msg =
            "DONE Bet - Sign this message to confirm you control this wallet.\n\n" +
